...
Route::middleware(['user'])->group(function (){
    ...
    Route::get('pengaduan/image-upload', 'AduanController@imageUpload')->name('image.upload');
    Route::post('pengaduan/image-upload', 'AduanController@imageUploadPost')->name('image.upload.post');
